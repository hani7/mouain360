...
SECRET_KEY = 'django-insecure-8*t6u=wb0#wr)*5_w2v(1hkv)afptec$_-ir#k$-=kw#x_pb_r'
...
LOGIN_REDIRECT_URL = '/viewer/houses/'
...
TEMPLATES = [
    {
        ...
        'DIRS': [],
        'APP_DIRS': True,  # This should be set to True to allow app-level templates
        'OPTIONS': {
            'context_processors': [
...
# Si tu as un dossier global pour les fichiers statiques
STATICFILES_DIRS = [
